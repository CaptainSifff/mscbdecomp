! compile with
! gfortran -I ../../Libraries/libmscbdecomp/ -L ../../Libraries/libmscbdecomp/ 3-TraceLessDiag-lmult.F90 -lmscbdecomp

Program TracelessExpTest

  Use TraceLessSingleColExp_mod

        COMPLEX (KIND=8) :: myx
        
        type(TraceLessSingleColExp) :: test
